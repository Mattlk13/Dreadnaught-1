...
void dma_set_mode (u8int channel, u8int mode);

//! prepares for generic channel read
void dma_set_read (u8int channel);

//! prepares for generic channel write
void dma_set_write (u8int channel);

//! sets the address of a channel
void dma_set_address(u8int channel, u8int low, u8int high);

//! sets the counter of a channel
void dma_set_count(u8int channel, u8int low, u8int high);

//! masks a channel
void dma_mask_channel (u8int channel);

//! unmasks a channel
void dma_unmask_channel (u8int channel);
...
void dma_set_external_page_register (u8int reg, u8int val);
